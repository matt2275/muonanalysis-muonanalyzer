...
muon = cms.EDAnalyzer('HIUPC_Analysis_Electrons_FullAODAnalyzer',
        ...
        maxDzProbeTrkElectron = cms.double(0.1), # max Dz(mu1,mu2)
        maxRelPtProbeTrkElectron = cms.double(1.0),# max [pt(mu)-pt(trk)]/pt(trk) for probe/offline
        maxDRProbeTrkElectron =  cms.double(0.3), # max DR for probe/offline
        maxDzProbeTrkPFC = cms.double(0.1), # max Dz(mu1,mu2)
        maxRelPtProbeTrkPFC = cms.double(1.0),# max [pt(mu)-pt(trk)]/pt(trk) for probe/offline
        maxDRProbeTrkPFC =  cms.double(0.3), # max DR for probe/offline
