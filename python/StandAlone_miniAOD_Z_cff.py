...
muon = cms.EDAnalyzer('StandAloneMuonMiniAODAnalyzer',
           ...
           minPtTrkSA=cms.double(3.0),  # min Pt for trk matching for SA muons
           maxDzProbeTrkSAMuon = cms.double(10.0), # max Dz(trk,SAmu)
           maxRelPtProbeTrkSAMuon = cms.double(1.0),# max [pt(SAmu)-pt(trk)]/pt(trk) for probe/offline
           maxDRProbeTrkSAMuon =  cms.double(1.0), # max DR for trk / SA muon
