...
#ifndef MuonAnalysis_MuonAnalyzer_Analysis_MuonMiniIsolation
#define MuonAnalysis_MuonAnalyzer_Analysis_MuonMiniIsolation
...
inline void FillMiniIso(
    const std::vector<PFCANDS> &pfcands, const MUON &mu, const double rho, Analysis_NtupleContent &nt, bool isTag) {
